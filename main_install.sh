...
(cd ~/.ssh && cp id_rsa.pub /home/vagrant/diplom_netology/terraform && cd ~ && cd diplom_netology)
...
echo "---------------------------------------------------------------"
echo "Инфраструктура развернута, используя мастер сервер можно подключится к Grafana и приложению."
